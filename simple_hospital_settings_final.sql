-- Simple Hospital Settings Setup (Final Fixed Version)
...
-- Insert default hospital if it doesn't exist (without updated_at)
...
-- Update existing hospital settings if record exists
UPDATE hospitals 
SET 
...
-- Show current hospitals table structure for verification
DESCRIBE hospitals;

...
-- Create corresponding staff records
INSERT INTO doctors (user_id, hospital_id, employee_id, first_name, last_name, specialization, consultation_fee, is_available) VALUES
(@doctor_id, 1, 'DOC001', 'Dr. Rajesh', 'Sharma', 'General Medicine', 500.00, 1)
ON DUPLICATE KEY UPDATE 
    is_available = 1,
    consultation_fee = 500.00;

INSERT INTO patients (user_id, hospital_id, patient_id, first_name, last_name, phone, gender, date_of_birth) VALUES
